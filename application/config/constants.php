...
define('PROJECT_Gallery_ALLOWED_TYPES',        'gif|jpg|png|jpeg');
...
define('PROJECT_DOCUMENT_UPLOAD_PATH_PROPRTYIMAGE',        './assets/uploads/propertyimage/');
...
define('BANNER_MAX_HEIGHT',        -1);
define('BANNER_MAX_WIDTH',            -1);
...
define('BRAND_MAX_HEIGHT',        -1);
define('BRAND_MAX_WIDTH',            -1);
define('BRAND_MAX_SIZE',            102400);
define('BRAND_ALLOWED_TYPES',        'gif|jpg|png|jpeg');
define('BRAND_UPLOAD_PATH',        './assets/uploads/brand/');
define('BRAND_THUMB_UPLOAD_PATH',    './assets/uploads/brand/thumbnail/');
define('BRAND_THUMB_MAX_WIDTH',    250);
define('BRAND_THUMB_MAX_HEIGHT',    250);

define('JOBPOST_MAX_HEIGHT',        -1);
define('JOBPOST_MAX_WIDTH',            -1);
define('JOBPOST_MAX_SIZE',            102400);
define('JOBPOST_ALLOWED_TYPES',        'gif|jpg|png|jpeg');
define('JOBPOST_UPLOAD_PATH',        './assets/uploads/jobpost/');
define('JOBPOST_THUMB_UPLOAD_PATH',    './assets/uploads/jobpost/thumbnail/');
