 ...
 <section class="page_banner" style="background-image: url(<?php echo $this->config->item('front_assets'); ?>images/bg/recruitment.jpg);">
     <div class="container largeContainer">
         <div class="row">
             <div class="col-md-6">
                 <h2 class="banner-title">Recruitment</h2>
             </div>

         </div>
         <div class="row">
             <div class="banner-subtitle">Expert Recruitment Service provider for a Stronger Workforce</div>
         </div>
     </div>
 </section>
 <!-- End:: Slider Section -->
