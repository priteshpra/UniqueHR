 ...
 <section class="page_banner" style="background-image: url(<?php echo $this->config->item('front_assets'); ?>images/bg/banking_insurance.jpg);">
     <div class="container largeContainer">
         <div class="row">
             <div class="col-md-6">
                 <h2 class="banner-title">Banking, Finance & Insurance</h2>
             </div>

         </div>
         <div class="row">
             <div class="banner-subtitle">Investing in People, Banking on Success</div>
         </div>
     </div>
 </section>
 <!-- End:: Slider Section -->
