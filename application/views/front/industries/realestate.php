 ...
 <section class="page_banner" style="background-image: url(<?php echo $this->config->item('front_assets'); ?>images/bg/realestate.jpg);">
     <div class="container largeContainer">
         <div class="row">
             <div class="col-md-6">
                 <h2 class="banner-title">Real Estate</h2>
             </div>

         </div>
         <div class="row">
             <div class="banner-subtitle">Building Stronger Teams, Building Better Properties</div>
         </div>
     </div>
 </section>
 <!-- End:: Slider Section -->
