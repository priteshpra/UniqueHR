...
<head>
  ...
  <meta name="description" content="Shreeya CRM">
  <meta name="keywords" content="Shreeya CRM">
  <title>Login</title>
      ...
      <form class="login-form z-depth-4 card-panel" action="<?php echo $this->config->item('base_url'); ?>admin/usersession/postLogin" method="post">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?php echo $this->config->item('admin_assets'); ?>img/logo_01.png" alt="" class="responsive-img valign profile-image-login">
            <?php //echo label('msg_lbl_site_title_name');?>
            <!-- <h1 class="logo_header">Samarth Group</h1> -->
          </div>
        </div>
       <!--  <?php            
